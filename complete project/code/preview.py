...
class Preview:
	def __init__(self):
		...
		self.shape_surfaces = {shape: load(os.path.join(os.path.dirname(__file__), '..', 'graphics', f'{shape}.png')).convert_alpha() for shape in TETROMINOS.keys()}
	...
	def run(self,game_over, next_shapes):
		if game_over==False:
