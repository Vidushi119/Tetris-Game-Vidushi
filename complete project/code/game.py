...
# class Game:
#     def __init__(self, main_instance, get_next_shape, update_score):
...
#         # sound 
#         self.landing_sound = pygame.mixer.Sound(os.path.join(os.path.dirname(__file__), '..', 'sound', 'landing.wav'))
